...
#        Date: 2026-05-12T11:18:21.692522
...
with DAG(
    ...
    tasks["pnp-simulation-config"] = KubernetesPodOperator(
        task_id="pnp-simulation-config",
...
"config_output_dir": "{{ params.config_output_dir }}"},
    ...
    tasks["__procodile_final_step__"] = PythonOperator(
        ...
        op_kwargs={
            "upstream_task_id": "pnp-simulation-config"
        },
        do_xcom_push=True
    )

    tasks["pnp-simulation-config"] >> tasks["__procodile_final_step__"]
