...
#        Date: 2026-05-12T10:37:22.537198
...
with DAG(
    ...
    tasks["pisa-generation-config"] = KubernetesPodOperator(
        task_id="pisa-generation-config",
...
"scene_output_dir": "{{ params.scene_output_dir }}"},
    ...
    tasks["__procodile_final_step__"] = PythonOperator(
        ...
        op_kwargs={
            "upstream_task_id": "pisa-generation-config"
        },
        do_xcom_push=True
    )

    tasks["pisa-generation-config"] >> tasks["__procodile_final_step__"]
