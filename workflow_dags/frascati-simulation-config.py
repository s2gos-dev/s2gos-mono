...
#        Date: 2026-05-12T11:18:21.669272
...
with DAG(
    dag_id="frascati-simulation-config",
...
"config_output_dir": "{{ params.config_output_dir }}"},
    ...
    tasks["__procodile_final_step__"] = PythonOperator(
        ...
        op_kwargs={
            "upstream_task_id": "frascati-simulation-config"
        },
        do_xcom_push=True
    )

    tasks["frascati-simulation-config"] >> tasks["__procodile_final_step__"]
