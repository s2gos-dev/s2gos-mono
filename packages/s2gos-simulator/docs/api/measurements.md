...
Measurement configuration classes that specify which radiometric quantities to
simulate, covering flux density, reflectance factors (BRF, HDRF, HCRF, BHR),
pixel-level variants, and the location of hemispherical measurements.

::: s2gos_simulator.config.measurements.FluxConfig
