...
def generation_configs(
    ...
    config = create_scene_config(
        ...
        data_overrides={
            "material_config_path": "/home/gonzalezm/test/test2/s2gos-apps/packages/s2gos-generator/resources/data/materials.json"
        },
    ...
    thermoprops = ThermophysicalConfig(
        ...
        thermoprops_file=UPath(
            "/home/gonzalezm/test/test2/s2gos-apps/example/PNP/timeseries_ms_2020-12-21_v1.nc"
        ),
    )
