...
def simulation_configs(
    ...
    print(f"[kairouan simulation_config] config_output_dir raw: {config_output_dir!r}")
    ...
    print(f"[kairouan simulation_config] config_output_upath={config_output_upath!r}  cid={cid!r}")
    ...
    print(f"[kairouan simulation_config] config_path={config_path!r}")
    if config_path is not None:
        result = PathRef(value=str(config_path), cid=cid)
        print(f"[kairouan simulation_config] returning PathRef(value={result.value!r}, cid={result.cid!r})")
        return result
    return None
