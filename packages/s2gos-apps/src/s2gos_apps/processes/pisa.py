...
@registry.process(id="pisa-simulation-config", title="Pisa Simulation Config")
def simulation_configs(
    ...
    print(f"[pisa simulation_config] config_output_dir raw: {config_output_dir!r}")
    ...
    print(f"[pisa simulation_config] config_output_upath={config_output_upath!r}  cid={cid!r}")
    ...
    print(f"[pisa simulation_config] config_path={config_path!r}")
    if config_path is not None:
        result = PathRef(value=str(config_path), cid=cid)
        print(f"[pisa simulation_config] returning PathRef(value={result.value!r}, cid={result.cid!r})")
        return result
    return None
